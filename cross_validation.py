...
class CSCV:
    ...
    def fit(self):
        ...
        list_partitions=list(range(self.S))
        random.shuffle(list_partitions)      
        list_combinations=[rand_list for rand_list in itertools.combinations(list_partitions, int(self.S/2))]
...
class k_fold_CV:
    ...
    def fit(self):
        ...
        list_partitions=list(range(self.K))
        random.shuffle(list_partitions)
        list_combinations=[rand_list for rand_list in itertools.combinations(list_partitions, int(self.K-1))]
...
class CPCV:
    ...
    def fit(self):
        ...
        list_partitions=list(range(self.N))
        random.shuffle(list_partitions)
        list_combinations=[rand_list for rand_list in itertools.combinations(list_partitions, int(self.N-self.K))]
